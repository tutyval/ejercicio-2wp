...
class NotificationsManager
{
    ...
    private static $remote_data_url_base = "http://localhost/tests/notifications/";
    ...
    public static function getRemoteNotifications($current_notifications = array())
    {
        ...
        if ( ! $notifications) {
            ...
            if ($data instanceof \WP_Error) {
                ...
                if (isset($data['code']) && $data['code'] === 'extendthemes_notifications_data_ok') {
                    ...
                    if ( ! NotificationsManager::isDevMode()) {
                        set_transient($transientKey, $data['data'], 3600);
                    } else {
    ...
    public static function load($notifications)
    {
        ...
        $notifications = NotificationsManager::getRemoteNotifications($notifications);
